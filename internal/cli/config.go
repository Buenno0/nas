...
func cmdConfig(args []string) error {
	...
	case "nuvem.aceleracao":
		b, err := strconv.ParseBool(value)
		if err != nil {
			return fmt.Errorf("nuvem.aceleracao: use true ou false")
		}
		cfg.Nuvem.Aceleracao = b
	case "nuvem.endereco":
